...
<template>
  <section class="w-full bg-blueBackground py-20 px-4">
...
<<<<<<< HEAD
          <span class="text-2xl lg:text-4xl">{{ conteudo.label }}</span>
=======
...
<<<<<<< HEAD
        <h2 class="text-2xl lg:text-5xl font-bold mb-4">{{ secoes[abaAtiva].titulo }}</h2>
